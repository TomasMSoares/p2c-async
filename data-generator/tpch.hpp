...
struct TableDef {
    ...
    template<template<typename...> class TupleLike>
    using forward_columns = TupleLike<Ts...>;
};
 ...
 * );
 **/
using customer = TableDef<int32_t, std::string_view, std::string_view, int32_t, std::string_view,
                          double, std::string_view, std::string_view>;
[[maybe_unused]] constexpr std::array customer_c{"c_custkey",    "c_name",   "c_address",
 ...
 **/
using lineitem =
    TableDef<int64_t, int32_t, int32_t, int32_t, double, double, double, double, char, char, date,
 ...
 * );
 **/
using orders = TableDef<int64_t, int32_t, char, double, date, std::string_view, std::string_view,
                        int32_t, std::string_view>;
 ...
 * );
 **/
using part = TableDef<int32_t, std::string_view, std::string_view, std::string_view,
                      std::string_view, int32_t, std::string_view, double, std::string_view>;
[[maybe_unused]] constexpr std::array part_c{"p_partkey",   "p_name",        "p_mfgr",
...
[[maybe_unused]] constexpr std::array partsupp_c{"ps_partkey", "ps_suppkey", "ps_availqty",
 ...
 * );
 **/
using supplier = TableDef<int32_t, std::string_view, std::string_view, int32_t, std::string_view,
                          double, std::string_view>;
[[maybe_unused]] constexpr std::array supplier_c{
    "s_suppkey", "s_name", "s_address", "s_nationkey", "s_phone", "s_acctbal", "s_comment"};
enum supplier_columns : uint8_t {
    s_suppkey,
    s_name,
    s_address,
    s_nationkey,
