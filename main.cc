...
produce(std::move(sort12), std::vector<IU*>{nation, o_year, sum_profit}, std::vector<std::string>{"nation","o_year","sum_profit"}, make_unique<AssertTupleSink>(expectedValues));
return 0;
}
